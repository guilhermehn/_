...
describe('_', function () {
  it('should work', function () {
    ...
    expect(bandAlbum(albums[0])).be('Exodus - Bonded By Blood');

    expect(_.map(bandAlbum, albums)[0]).be('Exodus - Bonded By Blood');
  });
  ...
  describe('Examples', function () {
    ...
    it('Example #2', function () {
      ...
      expect(findNumbers([undefined, null, 1, {}, 2, false, 3])).eql([1, 2, 3]);
    });
  });
  ...
  describe('README code tests', function () {
    it('should work property', function () {
      ...
      expect(sum(doubleNumbers(getEvens(numbers)))).be(40);
      ...
      expect(sumDoubleEvens(numbers)).be(40);
    });
  });
});
